...
ActiveRecord::Schema.define(version: 20170422172108) do
  ...
  create_table "participants", id: false, force: :cascade do |t|
    t.integer "decision_id"
    t.integer "user_id"
    t.index ["decision_id", "user_id"], name: "index_participants_on_decision_id_and_user_id", unique: true
    t.index ["user_id", "decision_id"], name: "index_participants_on_user_id_and_decision_id", unique: true
  end
