...
class DecisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create decision" do
    assert_difference('Decision.count') do
      post decisions_url, params: { decision: { decision_text: @decision.decision_text, location: @decision.location } }
    end
  ...
  test "should update decision" do
    patch decision_url(@decision), params: { decision: { decision_text: @decision.decision_text, location: @decision.location } }
